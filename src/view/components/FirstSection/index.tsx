...
export const FirstSection = () => {
  ...
  const [visualDescription, setVisualDescription] = useState<string>(
    quizList?.visualDescription ? quizList.visualDescription : ""
  );
  const [invalidMessage, setInvalidMessage] = useState("");
  const [sex, setSex] = useState(
    quizList?.patientSex ? quizList.patientSex : ""
  );
    ...
    <div className={s.PatientInformation}>
      ...
      <div className={s.inner}>
        <InputText
          title={"ФИО пациента"}
          subtitle={
            "В случае отсутствия данных о личности, внести информацию по визуальному осмотру"
          }
        ...
        <Textarea
          ...
          onBlur={() => onBlurHandler("visualDescription", visualDescription)}
        />
